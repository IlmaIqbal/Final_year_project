...
<body>
                                ...
                                <div class="col-lg-7">
                                    <form action="" class="form">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <a href="" id="pay_now" class="btn btn-primary w-100">Pay Now</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <script>
        document.getElementById('pay_now').addEventListener('click', function(event) {
            ...
            fetch("{{ route('store.admin.booking') }}", {
                    method: "POST",
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        window.location.href = "{{ route('events.adminBill') }}"; // Redirect to bill page
                    } else {

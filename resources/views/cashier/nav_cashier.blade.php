    ...
    <div class="sidebar">
        ...
        <ul>
            <li class="sidebar-item">
                <a href="{{ route('cashier.home') }}"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
            </li>
            <li class="sidebar-item">
                ...
                <ul class="collapse list-unstyled" id="inventory">
                    <li class="sidebar-item">
                        <a href="{{ route('cashier.payment') }}">Completed</a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{route('cashier.pending')}}">Pending</a>
                    </li>
                </ul>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('cashier.notifications.read', $notification->id) }}">
                                ...
                                <li><a class="dropdown-item" href="{{ route('cashier.notification') }}">View
                                        All</a>
                                </li>
                            </ul>
                        </li>

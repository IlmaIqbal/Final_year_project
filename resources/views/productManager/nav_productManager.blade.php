...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            <li class="sidebar-item">
                <a href="{{ route('productManager.home') }}"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
                <a href="{{route('productManager.reorder')}}">
                    <!-- mainly date and time for order history -->
    ...
    <div class="main-content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                ...
                                <a href="{{ route('productManager.notification') }}"
        ...
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('productManager.home')}}"> Home </a></li>

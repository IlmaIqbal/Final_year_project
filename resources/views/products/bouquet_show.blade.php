...
<div class="card bg-body-secondary" style="width: 30rem; height: 30rem;">
    <img class="card-img-top" style="width: 10rem; height: 10rem; object-fit: cover;" src="/image/{{ $bouquet->image }}" alt="Card image cap">
    <div class="card-body">
        ...
        <a href="{{ route('products.bouquet')}}" class="btn btn-primary">Go Back</a>
    </div>
</div>
@endsection
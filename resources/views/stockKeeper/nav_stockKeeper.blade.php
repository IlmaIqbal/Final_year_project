...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            <li class="sidebar-item">
                <a href="{{ route('stockKeeper.home') }}"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
                <a href="{{route('stockKeeper.order')}}">
    ...
    <div class="main-content">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('stockKeeper.notifications.read', $notification->id) }}">
                                ...
                                <li><a class="dropdown-item" href="{{ route('stockKeeper.notification') }}">View
                                        All</a>
                                </li>
                            </ul>
                        </li>
        ...
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('stockKeeper.home')}}"> Home </a></li>

            ...
            <div class="card border-info mb-3" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><strong><i class="fas fa-coins"></i></strong> Rs.
                            {{ $venue->price }} Per Hour
                        </li>
                        <li class="list-group-item"><strong><i class="fas fa-user-friends"></i></strong>
                            {{ $venue->capacity }} Guests
                        </li>
                        <li class="list-group-item "><strong><i class="fas fa-map-marker-alt"></i></strong>
                            {{ $venue->location }}
                        </li>

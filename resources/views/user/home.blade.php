            ...
            <div class="col-md-4">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('customers.services.catering') }}" class=" btn btn-outline-primary">View
                            More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">A decoration is anything used to make something more attractive or festive.
                        </p>
                        <a href="{{ route('customers.services.decoration') }}" class=" btn btn-outline-primary">View
                            More</a>
                    </div>
                </div>
            </div>

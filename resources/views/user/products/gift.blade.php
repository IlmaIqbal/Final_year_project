...
<section class="pt-5 pb-5">
    <div class="container">
        ...
        <div class="row"> {{-- ✅ All product cards go inside this single row --}}
            ...
            @php
            $avaStock = $gift->qty - $gift->issue_qty;
            @endphp
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img class="img-fluid" alt="100%x280" src="/image/{{ $gift->product->image }}">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <button class="btn btn-primary rounded-pill add-to-cart"
                                    ...
                                    data-price="{{ $gift->sell_price }}" data-image="/image/{{ $gift->product->image }}"
                                    data-stock="{{$avaStock}}">
                                    Add to cart
                                </button>

...
Route::get('/ajaxpage', [EmployeeController::class, 'ajaxpage']);
//customers Route
...
Route::post('province/', [ProvinceController::class, 'store'])->name('province.store'); // not any page exist but it has a function to store data in database
Route::delete('province/{province_id}/disable', [ProvinceController::class, 'disable'])->name('province.disable');
Route::post('province/{province_id}/enable', [ProvinceController::class, 'enable'])->name('province.enable');
Route::get('/province/{province_id}/edit', [ProvinceController::class, 'edit'])->name('province.edit');
Route::put('/province/{province}', [ProvinceController::class, 'update'])->name('province.update');

//district
Route::get('province/districtTable/{province_id}', [ProvinceController::class, 'indexDistrict'])->name('province.districtTable'); // need to be table 
Route::get('province/district/{province_id}', [ProvinceController::class, 'createDistrict'])->name('province.district'); // need to be table 
Route::post('district/', [ProvinceController::class, 'storeDistrict'])->name('district.store');
Route::delete('district/{district_id}/disable', [ProvinceController::class, 'disableDistrict'])->name('district.disable');
Route::post('district/{district_id}/enable', [ProvinceController::class, 'enableDistrict'])->name('district.enable');
Route::get('/district/{district_id}/edit', [ProvinceController::class, 'editDistrict'])->name('district.edit');
Route::put('/district/{district}', [ProvinceController::class, 'updateDistrict'])->name('district.update');

//division
Route::get('province/divisionTable/{district_id}', [ProvinceController::class, 'indexDivision'])->name('province.divisionTable');
Route::get('province/division/{district_id}', [ProvinceController::class, 'createDivision'])->name('province.division'); // need to be table 
Route::post('division/', [ProvinceController::class, 'storeDivision'])->name('division.store');
Route::delete('division/{division_id}/disable', [ProvinceController::class, 'disableDivision'])->name('division.disable');
